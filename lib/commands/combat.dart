...
Future<void> combatCommand(ISlashCommandInteractionEvent event) async {
  ...
  var msgText;
  var resLogo;
  var baseImageFile = File('./images/combatbase.png').uri.pathSegments.last;
  ...
  drawString(
      baseImage!,font: BitmapFont.fromZip(varino),x: 546,y: 38, 'WING MASSACRE MISSION');
